...
class CUZKCHU(Source):
    ...
    def get_vector(self, extent, EPSG):
        ...
        path = '/vsizip/' + os.path.join(os.path.dirname(os.path.abspath(__file__)), '..', '..', 'data', 'vsechnyVrstvy.zip') + '/shp/ChraneneUzemi.shp'
        vector = QgsVectorLayer(path, "ČÚZK DATA 50 - Chráněná území", "ogr")
