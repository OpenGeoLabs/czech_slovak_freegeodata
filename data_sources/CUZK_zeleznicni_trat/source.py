...
class Zeleznicnitrat(Source):
    ...
    def get_vector(self, extent, EPSG):
        ...
        path = '/vsizip/' + os.path.join(os.path.dirname(os.path.abspath(__file__)), '..', '..', 'data', 'vsechnyVrstvy.zip') + '/shp/ZeleznicniTrat.shp'
        vector = QgsVectorLayer(path, "Železniční trať", "ogr")
